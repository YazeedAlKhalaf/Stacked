...
export class YamlHelper {
  public static initializeWithDependencies() {
    ...
    this.addDependencyToPubspec("stacked", "1.5.1");
    this.addDependencyToPubspec("stacked_services", "0.3.1");
    this.addDependencyToPubspec("logger", "0.7.0+2");
    this.addDependencyToPubspec("get_it", "3.0.3");
    this.addDependencyToPubspec("injectable", "0.4.0");
    this.addDependencyToPubspec("logger", "0.9.1");
    this.addDependencyToPubspec("flutter_spinkit", "4.1.2+1");
